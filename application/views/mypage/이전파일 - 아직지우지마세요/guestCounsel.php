		<div class="hostWrap">
			<div class="title3">
				<div class="underline">客户 - 咨询列表</div>
			</div>
			...
			<div class="contents_list2">
				<div class="list_image1">
					...
					<img src="/application/views/images/contents/img01.jpg" alt="" class="pic1_img" style="width: 250px; height: 180px;">
			...
			</div><!-- contents_list2 닫음 -->
			<div class="contents_list3">
				<div class="rightColorband" id="rightColorband">
					<span class="rightStatus" id="rightStatus">咨询中</span>
				</div>
				<div class="rightDate" id="rightDate"><span>预定日期</span><br><span>2014. 10. 30</span>
				</div>
				<div class="rightPriceWrap" id="rightPriceWrap">
					<span>确定价格</span>
					<span id="rightPrice">1500元</span>
				</div>
			</div><!-- contents_list3 닫음 우측 가격내용 -->
