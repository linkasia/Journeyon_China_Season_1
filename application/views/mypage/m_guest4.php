		<div class="profileWrap1">
			...
			<div class="title1">
				<div class="underline">취소현황</div>
			</div>  <!-- 라인 들어가는 타이틀 city부분 복제 -->
			<div class="btn-group sortGroup" role="group" aria-label="" id="cancelsortGroup1">
				<button type="button" class="btn" id="cancelsort1" name="cancelsort1">전체보기</span></button>
				<button type="button" class="btn" id="cancelsort2" name="cancelsort2">구매자 취소<span id="sortNumber1" name="sortNumber1">(40)</span></button>
				<button type="button" class="btn" id="cancelsort3" name="cancelsort3">판매자 취소<span id="sortNumber2" name="sortNumber2">(20)</span></button>
			</div>
			<div class="btn-group sortGroup" role="group" aria-label="" id="cancelsortGroup2">
				<button type="button" class="btn" id="cancelsort1" name="cancelsort1">최근정렬</button>
				<button type="button" class="btn" id="cancelsort1" name="cancelsort2">과거정렬</button>
				<button type="button" class="btn" id="cancelsort1" name="cancelsort3">기간선택</button>
			</div>
