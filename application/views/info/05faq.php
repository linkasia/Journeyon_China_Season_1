    ...
    <div class="panel-group" id="accordion">
		...
		<div class="panel panel-default">
            ...
            <div id="collapseOne" class="panel-collapse collapse in">
                <div class="panel-body">
                    <p>个人认证是对个人用户真实身份的确认。确认来源包括其他认证用户的证明或者相关材料证明。所有的认证服务是免费的。</p>
                </div>
            </div>
        </div>
		...
		<div class="panel panel-default">
            ...
            <div id="collapseTwo" class="panel-collapse collapse">
                <div class="panel-body">
                    <p>得到认证，用户易于被识辨。发布的内容更权威，提高可信度，有利于交易双方。</p>
                </div>
            </div>
        </div>
		...
		<div class="panel panel-default">
            ...
            <div id="collapseSix" class="panel-collapse collapse">
                <div class="panel-body">
                    <p>在首页顶部“登录“，点击您要绑定帐号的博客名进入相应的博客页面，然后点击右侧栏的“博客设置”，在“同步”一栏下设置绑定各个社交帐号，目前支持新浪微博 、腾讯微博、豆瓣、Facebook、Instagram等等。</p>
                </div>
            </div>
        </div>
