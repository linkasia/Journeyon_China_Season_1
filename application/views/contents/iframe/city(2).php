<div id="contents_wrap1"> <!-- 컨텐츠 영역 나중에 include -->
	<div id="contents_wrapcenter"> <!-- 가운데로 가로값 줘서 가운데 정렬시키는 wrap -->
			...
			<div class="div_box2"> <!-- 현지인 & V인증마크 영역 -->
				<ul class="local"><img src="/application/views/images/left_menu/icon03_guide.PNG" alt=""><p class="stitle">导游特征</p>
					...
					<li>
						...
						<label for="checkboxG<?=$i?>" class="css-label" onclick="ckGuide('<?=$v->class?>','<?=$v->code?>','<?=count($guideType)?>')">
		...
		<section id="section_wrap"> <!-- 여기서부터 우측 감싸는 영역 -->
			...
			<div class="contents">
				<div class="contents_list1"  onclick="detail_page()">
					<div class="list_image1">
						<div class="band">
							...
							<img src="/application/views/images/contents/img01.jpg" alt="" class="img_270x180">
...
<script>
	...
	{
		location.href = "<?=site_url('City/country/Detailcity_search'); ?>";
	}
	...
	function ckGuide(cl,co,count)
	{
		for(var i=0; i <count; i++)
		{
			if(document.getElementById("checkboxG"+i).checked==true){
